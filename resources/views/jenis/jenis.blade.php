            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0 mb-2">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">Manage Jenis Document</h5>
                        </div>
                        <a href="#" class="btn bg-gradient-primary btn-sm mb-0" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">+&nbsp; Tambah Jenis Document</a>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <h5 class="modal-title" id="exampleModalLabel">New Jenis Document</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <form role="form text-left" method="POST" action="{{ route('tambah-jenis-dokumen') }}" enctype="multipart/form-data">
                                    @csrf
                                <div class="modal-body">
                                        @csrf
                                    <div class="mb-3">
                                        <label for="">Jenis Document</label>
                                        <input type="text" class="form-control" placeholder="Jenis Document" name="jenis" id="jenis" aria-label="jenis" aria-describedby="jenis" value="{{ old('jenis') }}">
                                        @error('jenis')
                        ...
                        <table id="myDataTable" class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="{{ route('delete-jenis-dokumen',$item->id) }}" type="button" >
...
<div class="modal fade" id="modaledit{{ $item2->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Jenis Document</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form role="form text-left" method="POST" action="{{ route('update-jenis-dokumen',$item2->id) }}" enctype="multipart/form-data">
            @csrf
        <div class="modal-body">
                @csrf
                <div class="mb-3">
                    <label for="">Jenis Document</label>
                    <input type="text" class="form-control" placeholder="Jenis Document" name="jenis" id="jenis" aria-label="jenis" aria-describedby="jenis" value="{{ old('jenis') ?? $item2->jenis }}">
                    @error('jenis')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                    @enderror
                </div>
