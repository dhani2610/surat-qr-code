                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nama Departement" name="nama" id="nama" aria-label="nama" aria-describedby="nama" value="{{ old('nama') }}">
                                        @error('nama')
...
<div class="modal fade" id="modaledit{{ $item2->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="">Nama Departement</label>
                    <input type="text" class="form-control" placeholder="Nama Departement" name="nama" id="nama" aria-label="nama" aria-describedby="nama" value="{{ old('nama') ?? $item2->nama }}">
                    @error('nama')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                    @enderror
                </div>
